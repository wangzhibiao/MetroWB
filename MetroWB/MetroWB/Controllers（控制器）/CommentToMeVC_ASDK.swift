...
/// 我的评论控制器
class CommentToMeVC_ASDK: BaseChildVC_ASDK {
...
extension CommentToMeVC_ASDK {
    ...
    override func loadData(){
        ...
        MTNetWorkTools.shared.CommentToMeRequest(since_id: someid, success: { (json) in
    ...
    override func loadMore() {
        ...
        MTNetWorkTools.shared.CommentToMeRequest(max_id: someid, success: { (json) in
...
/// 回复f评论代理方法
extension CommentToMeVC_ASDK: BaseTextEditorVCDelegate, ATMEStatusAndCmtCell_ASDKDelegate {
