...
/// 我的评论控制器
class CommentFromMeVC_ASDK: BaseChildVC_ASDK {
...
/// 加载数据方法
extension CommentFromMeVC_ASDK {
    ...
    override func loadData(){
        ...
        MTNetWorkTools.shared.CommentFromMeRequest(since_id: someid, success: { (json) in
    ...
    override func loadMore() {
        ...
        MTNetWorkTools.shared.CommentFromMeRequest(max_id: someid, success: { (json) in
...
/// 回复f评论代理方法
extension CommentFromMeVC_ASDK: BaseTextEditorVCDelegate, ATMEStatusAndCmtCell_ASDKDelegate {
